...
import { validateFieldData, getUnmappedColumns } from '../services/data-validation.service';
...
router.post('/upload', upload.single('file'), async (req: Request, res: Response) => {
  try {
    ...
    const unmappedColumns = getUnmappedColumns(parseResult.headers, fieldMappings);
